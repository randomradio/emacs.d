...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "font" '("font-" "make-font" "mswindows-font-" "x-font-" "tty-font-create-" "strikethru" "smallcaps" "set-font-" "dim" "dropcaps" "bold" "blink" "bigcaps" "reverse" "linethrough" "oblique" "overline" "underline" "italic")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "w3-display" '("w3-" "time-display")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "w3-hotindex" '("w3-hotindex" "member-nocase")))
